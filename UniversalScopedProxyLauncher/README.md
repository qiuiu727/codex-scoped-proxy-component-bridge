...
Download `ScopedProxyLauncher-Setup.exe` from Releases. The installer lets you choose the program folder, then asks whether to make a desktop shortcut. It always creates Start-menu entries for launching and configuration.
